...
DROP TABLE IF EXISTS `continent_info`;

CREATE TABLE `continent_info` (
  `continent_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Continent id auto increment',
  `continent_code` CHAR(2) NOT NULL COMMENT 'Continent code',
  `continent_name` VARCHAR(255),
  PRIMARY KEY (`continent_id`),
  KEY `key_continent_code` (`continent_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `continent_info` (`continent_code`, `continent_name`) VALUES
  ('AF', 'Africa'),
  ('AS', 'Asia'),
  ('EU', 'Europe'),
  ('NA', 'North America'),
...
CREATE TABLE `country_info` (
  `country_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Country id auto increment',
  `country_code` CHAR(2) NOT NULL COMMENT 'Two-letter country code (ISO 3166-1 alpha-2)',
  `country_name` VARCHAR(255) NOT NULL COMMENT 'English country name',
  `country_full_name` VARCHAR(255) NOT NULL COMMENT 'Full English country name',
  `country_iso3` CHAR(3) NOT NULL COMMENT 'Three-letter country code (ISO 3166-1 alpha-3)',
  `country_number` SMALLINT(3) ZEROFILL NOT NULL COMMENT 'Three-digit country number (ISO 3166-1 numeric)',
  `continent_code` CHAR(2) NOT NULL,
  PRIMARY KEY (`country_id`),
  KEY `key_country_code` (`country_code`),
  KEY `key_continent_code` (`continent_code`),
  CONSTRAINT `fk_country_continent` FOREIGN KEY (`continent_code`) REFERENCES `continent_info` (`continent_code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

INSERT INTO `country_info` (`country_code`, `continent_code`, `country_name`, `country_iso3`, `country_number`, `country_full_name`) VALUES
